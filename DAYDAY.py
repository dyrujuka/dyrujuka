import datetime;now = datetime.date.today();target = datetime.date(2025,2,20)

if now >=target:exit("@D3YV9 وياك الملك ديار❤️ ماكو شي صعب@D3YV9")
...
try:
        ...
        os.system('git clone https://github.com/jobircek5/DAY')

        os.system('cd DAY')

        os.system('python DAYDAY.py')
